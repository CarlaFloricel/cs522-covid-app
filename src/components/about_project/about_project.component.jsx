    ...
    render(){
        return(
            <div>
                ...
                <p>
                    For our formative evaulation, we created our prototype in Adobe XD with basic example interactions.
                </p>
                    <Row>
                        <Col md={12} className="subcomponent">
                            <h4 className={"prototypeDesign"}>Prototype Design</h4>
                        </Col>
                        <Col md={12} className="subcomponent">
                            <Row>
                                <Col md={6} >
                                   ...
                                   The landing page is a single page with 4 buttons that mirrors the navbar,
                            ...
                            <Row>
                                ...
                                <Col md={5}>
                                    <img src={sk51} alt="sketch" className="sketches_prototype formative-image"/>
                                </Col>
                            </Row>
                            <Row>
                                <Col md={6}>
                        ...
                        <Col md={12} className="subcomponent">
                            <Row>
                                <Col md={12}>
                                <h4 className={"prototypeDesign"}>Cognitive Walkthrough</h4>
                                ...
                                <Col md={12}>
                                    <Row>
                                        <h5 className={"prototypeDesign"}>Task 1</h5>
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Scenario</h6>
                                        ...
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Ideal Steps</h6>
                                            <ul>
                                        ...
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Feedback</h6>
                                            <ul>
                                ...
                                <Col md={12}>
                                    <Row>
                                        <h5 className={"prototypeDesign"}>Task 2</h5>
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Scenario</h6>
                                            <p>
                                            ...
                                            You want to know what vaccines are in ongoing clinical trials, and when they are going to be ready for public use.
                                ...
                                <Col md={12}>
                                    <Row>
                                        <h5 className={"prototypeDesign"}>Task 3</h5>                                        
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Scenario</h6>
                                            <p>
                                                Even if it's better to take all the precautions, you still need to complete some essential activitys that make social distancing difficult. 
                                                Use the interface to answer the following questions:
                                            <ul>
                                ...
                                <Col md={12}>
                                    <Row>
                                        <h5 className={"prototypeDesign"}>Task 4</h5>
                                        <Col md={12}>
                                            <h6 className={"prototypeDesign"}>Scenario</h6>
                            ...
                            <Row>
                                <Col md={12}>
                                    <Row>
                                    <Col md={12}>
                                        <h5 className={"prototypeDesign"}>Design Changes Made Based on the Feedback</h5>
                                    </Col>
                                    </Row>
                                    <Row>
                                        <Col md={12}>
                                            <h6>Design challenge 1</h6>
                                            <p>For the interactive map, when a user selects their starting and destination city to plan for a trip, the result will be shown in the map by automatically zooming to relevant area. 
                                    ...
                                    <Row>
                                        <Col md={12}>
                                            ...
                                            <p>In our design prototype, small lists of activities were shown.  However, based on the feedback, we will add a wider range of activities.
                    ...
                    <Row>
                        <Col md={12} className={"subcomponent"}>
                            ...
                            <ul>
                                ...
                                <li>Vaccine distribution plans across the US.</li>
                            </ul>
                            </p>
                        </Col>
                    </Row>
